<script lang="ts">
  ...
  //function to fetch contacts details
  ...
  //function to change searchQuery
  ...
  //function to filter contacts alphabetically
  ...
  // handle click to get contact info
...
{#if flag}
  <section
    class="md:w-1/3 w-4/5 max-h-screen overflow-scroll bg-white rounded-lg"
  >
...
{:else}
  ...
  >
    ...
    <ContactDetails
      bind:flag
      on:contactSelected={handleContactSelected}
      {filteredContacts}
    />
  </section>
{/if}
